...
<body>
	<div class="container">
		...
		<p align="center"><h3  align="center">Les Produits "Autres fournisseurs" choisis pour la semaine</h3></p><p />
		<table  align="center" style="width:60%">
		<?php
			$requeteDico = "SELECT t1_dictionnaireproduction.NumProduction, t4_famillesproduits.LibelleFamille, t1_dictionnaireproduction.NomProduction, t1_dictionnaireproduction.ImgProduit, t2_unitevente.LibelleUniteVente, t1_dictionnaireproduction.DernierPrixVente FROM t1_dictionnaireproduction INNER JOIN t4_famillesproduits ON t1_dictionnaireproduction.FamilleDeProduit = t4_famillesproduits.NumFamilleprod INNER JOIN t2_unitevente ON t1_dictionnaireproduction.UnitedeVente = t2_unitevente.NumUniteVente WHERE t1_dictionnaireproduction.producteur <>1 AND (t1_dictionnaireproduction.Selection OR t1_dictionnaireproduction.Permanent) ORDER BY t4_famillesproduits.LibelleFamille DESC, t1_dictionnaireproduction.NomProduction ASC";
