...
{	$TabledesID=array();
	...
	{	for ($num_de_ligne = 0; $num_de_ligne <= $NbLignes; $num_de_ligne++)
		...
		header('location: f2_fin_maj_prod.php' );  // Envoi sur la page de visualisation de la sélection (en format client)
		exit;
	}
}
?>
...
<html>
    ...
    <body>
		<form method="post" action="f1_choix_prod">
		<div class="container">
			<div class="col-md-12">
			...
			$requeteDico = "SELECT t1_dictionnaireproduction.NumProduction, t1_dictionnaireproduction.NomProduction, t4_famillesproduits.LibelleFamille, t2_unitevente.LibelleUniteVente, t1_dictionnaireproduction.DernierPrixVente, t1_dictionnaireproduction.Permanent, t1_dictionnaireproduction.producteur FROM t1_dictionnaireproduction INNER JOIN t2_unitevente ON t1_dictionnaireproduction.UnitedeVente = t2_unitevente.NumUniteVente INNER JOIN t4_famillesproduits ON t1_dictionnaireproduction.FamilleDeProduit = t4_famillesproduits.NumFamilleprod WHERE (((t1_dictionnaireproduction.Permanent)=0) AND ((t1_dictionnaireproduction.producteur)=1)) ORDER BY t1_dictionnaireproduction.FamilleDeProduit, t1_dictionnaireproduction.OrdreDeParution, t1_dictionnaireproduction.NumProduction;";
			...
			'<td class="tdthbord"><b><em>Prix</em></b></td><td class="tdthbord"><b><em>Sélection</em></b></td><td class="tdthbord"><b><em>Nouveau prix</em></b></td></tr>'; // la balise th ne fonctionne pas sous Firefox
